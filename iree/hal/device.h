...
// TODO(benvanik): check whether worth removing this/virtualizing everything.
// The host allocator is needed for every alloc/free of any resources created
// from the device so having it fast to access is (probably) worth it.
struct iree_hal_device_s {
