func.func public @concat_i64() {
  %cst_1 = arith.constant dense<1> : tensor<1x1xi64>
  ...
  %1 = util.optimization_barrier %cst_1 : tensor<1x1xi64>
  ...
  %concat = tensor.concat dim(1) %1, %2, %3, %4 : (tensor<1x1xi64>, tensor<1x1xi64>, tensor<1x1xi64>, tensor<1x1xi64>) -> tensor<1x4xi64>
