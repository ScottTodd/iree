...
// Emscripten can use JavaScript Promises.
#define IREE_HAVE_WAIT_TYPE_PIPE 1
#define IREE_HAVE_WAIT_TYPE_JS_PROMISE 1
...
enum iree_wait_primitive_type_bits_t {
  ...
  IREE_WAIT_PRIMITIVE_TYPE_JS_PROMISE = 6u,
...
#if defined(IREE_HAVE_WAIT_TYPE_JS_PROMISE)
  struct {
    int handle;
  } promise;
#endif  // IREE_HAVE_WAIT_TYPE_JS_PROMISE
