...
template <int SZ> static TypedAttr convertConstIntegerValue(TypedAttr value) {
...
template <int SZ> static TypedAttr convertConstFloatValue(TypedAttr value) {
...
template <typename T> static void printSwitchOp(OpAsmPrinter &p, T &op) {
  p << " ";
