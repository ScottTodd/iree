...
// // CHECK-LABEL: @cmp_eq_i32_folds
vm.module @cmp_eq_f32_folds {
  vm.func @const_eq() -> i32 {
    // CHECK: %c1 = vm.const.i32 1
    // CHECK-NEXT: vm.return %c1 : i32
    %c1 = vm.const.f32 1.0
    %c1d = vm.const.f32 1.0
    %eq = vm.cmp.eq.f32.o %c1, %c1d : f32
    vm.return %eq : i32
  }
}
...
//   // // TODO(scotttodd): figure out why this goes through the folder correctly
//   // //                  but canonicalizes anyways (check return types?)
...
// vm.module @cmp_gt_f32_folds {
//   vm.func @const_eq() -> i32 {
//     // CHECK: %c1 = vm.const.i32 1
//     // CHECK-NEXT: vm.return %c1 : i32
//     %c1 = vm.const.f32 5.0
//     %c2 = vm.const.f32 1.0
//     %eq = vm.cmp.gt.f32.o %c1, %c2 : f32
//     vm.return %eq : i32
//   }
// }
